            ...
            <div class="panel-body">
               ...
               Tambah
                ...
                <tr>
                  ...
                  <td><?php echo $data['keterangan_paket'] ?></td>
                     ...
                     <div class="box box-primary box-solid">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="form-group">
                          ...
                          <input required="" type="text" name="keterangan_paket" class="form-control" value="<?php echo $data1['keterangan_paket']; ?>">      
                        </div>
              ...
              if (isset($_POST['simpan'])) {
                ...
                $sql = $koneksi->query("update  tb_paket set nama_paket='$nama_paket', harga='$harga_oke', keterangan_paket='$keterangan_paket' where id_paket='$id_paket_ubah'");
            ...
            <div class="box-header with-border">
              ...
              <div class="modal-body">
                <form role="form"  method="POST"> 
                        ...
                        <div class="form-group">
                          <label>Keterangan Paket</label>
                          <input required="" type="text" name="keterangan_paket" class="form-control" >      
                        </div>
...
<?php 
      ...
      if (isset($_POST['tambah'])) {
        ...
        $sql = $koneksi->query("insert into tb_paket (nama_paket, harga, keterangan_paket)values('$nama_paket', '$harga_oke2',  '$keterangan_paket') ");
