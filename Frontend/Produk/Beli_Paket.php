    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          <h1>Mari Berlangganan Paket Internet di Banjar<span>Net</span></h1>
    ...
    <section id="belipaket" class="belipaket">
      ...
      <?php foreach($result as $paket) { ?>
        <div class="section-title">
          ...
          <h7><b style="color:orange;">Keterangan Paket : </b><?php echo $paket['keterangan_paket']?></h7>
        </div>
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form  method="post" role="form" >
              ...
              <div style='margin-top:10px;' class="text-center">
                <button name="beli" type="submit">Beli Paket</button>
              </div>
            </form>
            <?php  } ?>
          </div>
              ...
              echo "
                  ...
                  setTimeout(function() {
                    swal({
                        ...
                        text: 'Data Pembelian Paket Sedang di Proses, Tunggu Konfirmasi Selanjutnya',
                        type: 'success'
                    }, function() {
